...
MYEPfrontend_root.title("SAFE DRIVE FACIAL WARNING SYSTEM")
MYEPfrontend_root.geometry("720x480")  # Increased window width to accommodate message
MYEPfrontend_root.minsize(685, 350)
MYEPfrontend_root.resizable(False, False)  # Disable maximizing

background_image = Image.open("D:\R.H.S\Final Year\B.E. Project\Final\MYEP_Sending\\MYEP_DriverDowsiness.png")
...
student = Label(text="A project by\n Mandar Prashant Pandit, Yash Mahesh Malpathak, Esha Mahesh Malpathak, Prathamesh Kishor Gadgil",
                bg="White", fg="Black", font=("timesnewroman", 10, "bold"))
Dept = Label(text="DEPARTMENT OF COMPUTER ENGINEERING",
             bg="White", fg="Black", font=("timesnewroman", 10, "bold"))
colleg = Label(text="GES’S R H SAPAT COEMSR,",
                bg="White", fg="Black", font=("timesnewroman", 10, "bold"))
college = Label(text="Nashik-422 005, (M.S.), INDIA",
                bg="White", fg="Black", font=("timesnewroman", 10, "bold"))
